...
(defn location-regex-exact
  "takes a line number and returns a regex pattern with the exact line number"
  [line-n]
...
(expect (more-of x
                 ...
                 (location-regex-exact 60) (get-all-text (:msg-info-obj x)) ; use location-regex for generic line number testing
...
(expect (more-of x
                 ...
                 (location-regex-exact 66) (get-all-text (:msg-info-obj x))
...
(expect (more-of x
                 ...
                 (location-regex-exact 73) (get-all-text (:msg-info-obj x))
...
(expect (more-of x
                 ...
                 (location-regex-exact 84) (get-all-text (:msg-info-obj x))
...
(expect (more-of x
                 ...
                 (location-regex-exact 90) (get-all-text (:msg-info-obj x))
...
(expect (more-of x
                 ...
                 (location-regex-exact 103) (get-all-text (:msg-info-obj x))
...
(expect (more-of x
                 ...
                 (location-regex-exact 140) (get-all-text (:msg-info-obj x))
...
(expect (more-of x
                 ...
                 (location-regex-exact 153) (get-all-text (:msg-info-obj x))
...
(expect (more-of x
                 ...
                 (location-regex-exact 160) (get-all-text (:msg-info-obj x))
...
(expect (more-of x
                 ...
                 (location-regex-exact 171) (get-all-text (:msg-info-obj x))
...
(expect (more-of x
                 ...
                 (location-regex-exact 184) (get-all-text (:msg-info-obj x))
...
(expect (more-of x
                 ...
                 (location-regex-exact 194) (get-all-text (:msg-info-obj x))
...
(expect (more-of x
                 clojure.lang.ArityException (:exception-class x)
                 ;;; This is a legitimate location error, need to look into it -> The line number seems to indicate this file line 174
;;                  location-regex (get-all-text (:msg-info-obj x))
